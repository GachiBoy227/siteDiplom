...
$queryzadanie=mysqli_query($sql,"SELECT * FROM zadanie where gruppa='".$getgruppa."' order by id desc");
...
$queryres=mysqli_query($sql,"SELECT * FROM estimations where name='".$_COOKIE["login"]."' AND id_zadanie='".$getzadanie["id"]."'");
